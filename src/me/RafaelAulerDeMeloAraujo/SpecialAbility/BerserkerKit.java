...
/*    */ 
/*    */ public class BerserkerKit implements org.bukkit.command.CommandExecutor
/*    */ {
/*    */   private Main main;
/*    */   static Main plugin;
/*    */   
/*    */   public BerserkerKit(Main main)
/*    */   {
/* 20 */     this.main = main;
/* 21 */     plugin = main;
/*    */   }
...
/*    */     
/* 29 */     if (cmd.getName().equalsIgnoreCase("kberserker"))
/*    */     {
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/* 67 */       Habilidade.setAbility(p, "Berserker");
/* 68 */       p.sendMessage(String.valueOf(this.main.getConfig().getString("Prefix").replace("&", "§")) + this.main.getConfig().getString("Message.Kit").replaceAll("%kit%", "Berserker").replace("&", "§"));
/*    */       
...
/* 77 */         me.RafaelAulerDeMeloAraujo.TitleAPI.TitleAPI.sendTitle(p, Integer.valueOf(20), Integer.valueOf(60), Integer.valueOf(20), this.main.getConfig().getString("Title.KitTitle"), this.main.getConfig().getString("Title.KitSubTitle").replaceAll("%kit%", "Berserker"));
/*    */       }
/*    */     
/*    */     
/*    */ 
