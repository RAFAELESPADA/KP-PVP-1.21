...
public static void TeleportArenaRandom(final Player p) {
    ...
    switch (number) {
        ...
        case 1: {
            ...
            ;
            /* 216 */           Main.getFolia().getScheduler().teleportAsync(p, lobby2);
            break;
        }
        case 2: {
            ...
            ;
            /* 216 */           Main.getFolia().getScheduler().teleportAsync(p, lobby3);
            break;
        }
        case 3: {
            ...
            ;
            /* 216 */           Main.getFolia().getScheduler().teleportAsync(p, lobby4);
            break;
        }
        case 4: {
